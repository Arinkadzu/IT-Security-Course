...
<table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
    <tr> 
        <td>Шаг 1 из 3 : Ввод информации о доставке и оплате </td>
    </tr>
</table>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?step=2" method="post" name="frmCheckout" id="frmCheckout" onSubmit="return checkShippingAndPaymentInfo();">
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
      <tr>
        <td width="150" class="entryTableHeader">Способ оплаты </td>
        <td class="content">
        ...
        <label for="optCod" style="cursor:pointer">Наличными</label></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <p align="center"> 
        <input class="box" name="btnStep1" type="submit" id="btnStep1" value="Продолжить &gt;&gt;">
    </p>
</form>
